...
class SmokeForm extends React.Component {
  ...
  constructor(props) {
     ...
     this.state = {brand: 'Peterson', blend: 'Old Dublin', timenday: datestring, timeofday: timestring, comment: 'Your average good smoke'};
  ...
  commentChange(event) {
   ...
   handleSubmit(event) {
    alert('Something changed!: ' + this.state.brand + ' '  + this.state.blend + ' '  + this.state.timenday + ' ' + this.state.timeofday + ' '  + this.state.comment);
  ...
  return (
    <form onSubmit={this.handleSubmit}>
      ...
      <tr><td>Time:</td><td><input type="time" name="timeofday" size="50" value={this.state.timeofday} onChange={this.timeofdayChange}></input></td></tr>
